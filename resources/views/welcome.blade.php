        ...
        <div class="lg:W-2/4 mx-auto py-8 px-6 bg-white rounded-xl">
            ...
            <div class="mb-6">
                <form action="/" method="POST" class="flex flex-col space-y-4">
                    @csrf
                    <input type="text" name="title" placeholder="The todo title" class="py-3 px-4 bg-gray-100 ronded-xl">
                    
                    <textarea name="description"  placeholder="The todo description" class="py-3 px-4 bg-gray-100 ronded-xl"></textarea>
